...
for k = 1:21
    ...
    plot_band(horzs, irs_lp_la, ...
        ...
        plot_ylim, plot_xtick);
%     drawnow;
      saveas(gcf,['Rho_', num2str(rhod(k)),'_Lag_augmented_LP.png'])
...
%     drawnow;
    ...
    plot_band(horzs, irs_var_na, ...
        ...
        plot_ylim, plot_xtick);
%     drawnow;
    saveas(gcf,['Rho_', num2str(rhod(k)) ,'_Lag_augmented_VAR.png'])
